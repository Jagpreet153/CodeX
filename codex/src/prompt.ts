...
- Any component that uses state (useState, useEffect, etc.) MUST include "use client" at the very top. Failure to include this will break the app. Never forget this step.
